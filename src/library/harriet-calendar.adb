...
package body Harriet.Calendar is
   ...
   Clock_Reference : Harriet.Db.Calendar_Reference :=
     Harriet.Db.Null_Calendar_Reference;
   ...
   begin
      ...
      Harriet.Db.Calendar.Update_Calendar (Clock_Reference)
   ...
   procedure Check_Clock is
      use type Harriet.Db.Calendar_Reference;
   begin
      if Clock_Reference = Harriet.Db.Null_Calendar_Reference then
         Clock_Reference :=
           Harriet.Db.Calendar.First_Reference_By_Top_Record
   ...
   begin
      Check_Clock;
      Current_Clock := Harriet.Db.Calendar.Get (Clock_Reference).Clock;
   end Load_Clock;
   ...
   is
   begin
      Year := Harriet.Calendar.Year (Date);
      Month := Harriet.Calendar.Month (Date);
      Day := Harriet.Calendar.Day (Date);
      Seconds := Harriet.Calendar.Seconds (Date);
   end Split;
